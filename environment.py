...
class mfBatchEnvironment():
    ...
    def step(self, new_queries, fidelities):
        ...
        # calculate evaluation times and subtract one
        ...
        queries_finished = (self.query_times == 0)
        ...
        obs = []
        for query, fidelity in zip(queries_out, fidelities):
